var iPhoneStyle = function(selector_or_elems, options) {
  ...
  return(elems.each(function(elem) {
    ...
    var rightside = container.getWidth() - handle.getWidth() - options.widthConstant;
...
iPhoneStyle.defaults = {
  duration:          200,
  checkedLabel:      '<img src="images/pyes.png" width="14px" heght="10">', 
  uncheckedLabel:    '<img src="images/pno.png" width="9px" heght="10">', 
  resizeHandle:      true,
