...
<!-- CSS -->
<link href="<?= HOSTNAME ?>common.css?2012233255822" rel="stylesheet">
...
<script language="javascript"  src="<?= HOSTNAME ?>resources/scripts/wookmarkfiller.js?2321315"></script>
<script language="javascript"  src="<?= HOSTNAME ?>resources/scripts/modalpanel.js?20130222980"></script>
