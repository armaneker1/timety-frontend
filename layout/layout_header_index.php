...
<?php } else { ?>
    <link  href="<?= HOSTNAME ?>all_css.css?2013023335544" rel="stylesheet" type="text/css" />
...
<script language="javascript"  src="<?= HOSTNAME ?>resources/scripts/wookmarkfiller.min.js?201986744"></script>
