 ...
 * @package entity
 */
class TimeteMailReports extends Db2PhpEntityBase implements Db2PhpEntityModificationTracking {
	...
	public function &setSuccessCount($successCount) {
		$this->notifyChanged(self::FIELD_SUCCESS_COUNT,$this->successCount,$successCount);
		$this->successCount=$successCount;
		return $this;
	}

	/**
	 * get value for success_count 
	 *
	 * type:INT UNSIGNED,size:10,default:null
	 *
	 * @return mixed
	...
	public function &setFailCount($failCount) {
		$this->notifyChanged(self::FIELD_FAIL_COUNT,$this->failCount,$failCount);
		$this->failCount=$failCount;
		return $this;
	}

	/**
	 * get value for fail_count 
	 *
	 * type:INT UNSIGNED,size:10,default:null
	 *
	 * @return mixed
	 ...
	 * Query by Example.
	 *
	 * Match by attributes of passed example instance and return matched rows as an array of TimeteMailReports instances
	 *
	 * @param PDO $db a PDO Database instance
	 * @param TimeteMailReports $example an example instance defining the conditions. All non-null properties will be considered a constraint, null values will be ignored.
	 * @param boolean $and true if conditions should be and'ed, false if they should be or'ed
	 * @param array $sort array of DSC instances
	 * @return TimeteMailReports[]
	 */
	public static function findByExample(PDO $db,TimeteMailReports $example, $and=true, $sort=null) {
	 ...
	 *
	 * Will return matched rows as an array of TimeteMailReports instances.
	 *
	 * @param PDO $db a PDO Database instance
	...
	public static function findByFilter(PDO $db, $filter, $and=true, $sort=null) {
		...
		$sql='SELECT * FROM `timete_mail_reports`'
	...
	/**
	 * Will execute the passed statement and return the result as an array of TimeteMailReports instances
	 *
	...
	/**
	 * returns the result as an array of TimeteMailReports instances without executing the passed statement
	 *
	 * @param PDOStatement $stmt
	 * @return TimeteMailReports[]
	 */
	...
	/**
	 * Execute select query and return matched rows as an array of TimeteMailReports instances.
	 *
	...
	public static function deleteByFilter(PDO $db, $filter, $and=true) {
		...
		$sql='DELETE FROM `timete_mail_reports`'
		. self::buildSqlWhere($filter, $and, false, true);
		$stmt=self::prepareStatement($db, $sql);
		self::bindValuesForFilter($stmt, $filter);
		$affected=$stmt->execute();
	...
	public function toDOM() {
		return self::hashToDomDocument($this->toHash(), 'TimeteMailReports');
	}

	/**
	 * get single TimeteMailReports instance from a DOMElement
	 *
	...
	/**
	 * get all instances of TimeteMailReports from the passed DOMDocument
	 *
	...
	public static function fromDOMDocument(DOMDocument $doc) {
		$instances=array();
		foreach ($doc->getElementsByTagName('TimeteMailReports') as $node) {
